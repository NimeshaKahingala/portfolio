                ...
                <div className="content">
                    ...
                    <div className="details">
                        ...
                        <div className="social">
                            <ul>
                                <li><a href="https://www.facebook.com/Nimesha.Kahingala" target="_blank"><img className="icon" src={fbIcon}></img></a></li>
                                <li><a href="https://www.linkedin.com/in/nimesha-kahingala/" target="_blank"><img className="icon" src={linkedinIcon}></img></a></li>
                                <li><a href=""><img className="icon" src={mediumIcon}></img></a></li>
                                <li><a href="mailto:nimesha.isholi94@gmail.com"><img className="icon" src={emailIcon}></img></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
